...
const About = () => (
  <>
    ...
    <Container className="about">
      ...
      <Link href="/">
        <a className="about--close">
          <FiXCircle size={40} />
        </a>
      </Link>
      <h1 className="about__title">ABOUT</h1>
      <p className="about__description">Get to know some stuffs about me</p>
    </Container>

    <Container className="about-content">
      <div className="about-content--add-space">
        <h2 id="introduction">
          <FiUser /> Introduction
        </h2>
      ...
      <div className="about-content--add-space">
        ...
        <h5 className="about-content__company">
          Bizwind Philippines, Inc.&nbsp;
          <a className="about-content__company-link" href="http://www.bizwind.com/" target="_blank">
            <FiLink />
          </a>
          &nbsp;
          <Badge variant="secondary">Apr 2019 - May 2020</Badge>
        </h5>
        <p className="about-content__position">Junior Software Engineer</p>
      </div>
